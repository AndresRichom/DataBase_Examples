...
CREATE TABLE `productmodelillustration` (
  ...
  CONSTRAINT `FK_ProductModelIllustration_Illustration_IllustrationID` FOREIGN KEY (`IllustrationID`) REFERENCES `illustration` (`IllustrationID`),
  CONSTRAINT `FK_ProductModelIllustration_ProductModel_ProductModelID` FOREIGN KEY (`ProductModelID`) REFERENCES `productmodel` (`ProductModelID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Cross-reference table mapping product models and illustrations.';
...
INSERT INTO `productmodelillustration` VALUES (7,3,'2008-02-10 17:41:02'),(10,3,'2008-02-10 17:41:02'),(47,4,'2008-02-10 17:41:02'),(47,5,'2008-02-10 17:41:02'),(48,4,'2008-02-10 17:41:02'),(48,5,'2008-02-10 17:41:02'),(67,6,'2008-02-10 17:41:02');
...
-- Dump completed on 2026-03-20 20:24:58
