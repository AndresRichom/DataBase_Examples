...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Lookup table containing the languages in which some AdventureWorks data is stored.';
...
INSERT INTO `culture` VALUES ('','Invariant Language (Invariant Country)','2002-06-01 04:00:00'),('ar','Arabic','2002-06-01 04:00:00'),('en','English','2002-06-01 04:00:00'),('es','Spanish','2002-06-01 04:00:00'),('fr','French','2002-06-01 04:00:00'),('he','Hebrew','2002-06-01 04:00:00'),('th','Thai','2002-06-01 04:00:00'),('zh-cht','Chinese','2002-06-01 04:00:00');
